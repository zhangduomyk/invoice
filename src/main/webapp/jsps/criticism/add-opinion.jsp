...
<article class="page-container page-index">
    <form action="<c:url value="/opinion/insertOneRecord"/>" method="post" class="form form-horizontal" id="form-member-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>意见内容：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="opinions" id="critied" cols="" rows="" class="textarea"  placeholder="说点什么...30个字符以内" dragonfly="true" onblur="checkcriti()"></textarea>
