...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 日志管理 <span class="c-gray en">&gt;</span> 用户反馈 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<script type="text/javascript">
    ...
    function pageFoot() {
        ...
        for(var i = begin; i <= end; i++) {
            ulValue += '<li>';
            var st = "<c:url value="/opinion/pageRecord"/>?pageCode="+ i;
            ulValue += '<a class="am-btn-xs" id="newPage_' + i + '" href="<c:url value="/opinion/pageRecord"/>?pageCode='+i+'">'+i+'</a>';
            ulValue += '</li>';
        }
    ...
    function bindAtion() {
        ...
        $("#firstPage").bind("click", function() {
            window.location.href = '<c:url value="/opinion/pageRecord"/>?pageCode=1'
        });

        //'上一页'事件
        $("#upPage").bind("click", function() {
            var st = "<c:url value="/opinion/pageRecord"/>?pageCode="+ --pageCode;
        ...
        $("#endPage").bind("click", function() {
            var st = "<c:url value="/opinion/pageRecord"/>?pageCode="+ totalPage;
            window.location.href = st
        });
